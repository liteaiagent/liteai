...
| **auto** | Auto-approve most actions, prompt for dangerous ones | Experienced users comfortable with agent actions |
| **bypass** | Auto-approve everything without prompting | CI/CD pipelines, trusted automation |
