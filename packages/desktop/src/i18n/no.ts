export const dict = {
  ...
  "desktop.menu.help.documentation": "LiteAI Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "LiteAI CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
