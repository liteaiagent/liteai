...
const releaseId = process.env.LITEAI_RELEASE
if (!releaseId) throw new Error("LITEAI_RELEASE is required")

const version = process.env.LITEAI_VERSION
if (!releaseId) throw new Error("LITEAI_VERSION is required")
...
const targets = [
  { key: "linux-x86_64-deb", asset: "liteai-desktop-linux-amd64.deb" },
  { key: "linux-x86_64-rpm", asset: "liteai-desktop-linux-x86_64.rpm" },
  { key: "linux-aarch64-deb", asset: "liteai-desktop-linux-arm64.deb" },
  { key: "linux-aarch64-rpm", asset: "liteai-desktop-linux-aarch64.rpm" },
  { key: "windows-aarch64-nsis", asset: "liteai-desktop-windows-arm64.exe" },
  { key: "windows-x86_64-nsis", asset: "liteai-desktop-windows-x64.exe" },
  { key: "darwin-x86_64-app", asset: "liteai-desktop-darwin-x64.app.tar.gz" },
  {
    key: "darwin-aarch64-app",
    asset: "liteai-desktop-darwin-aarch64.app.tar.gz",
  },
]
