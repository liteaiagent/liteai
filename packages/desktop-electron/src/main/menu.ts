...
export function createMenu(deps: Deps) {
  ...
  const template: Electron.MenuItemConstructorOptions[] = [
    ...
    },
    {
      label: "Help",
      submenu: [
        { label: "LiteAI Documentation", click: () => shell.openExternal("https://liteai.ai/docs") },
        { type: "separator" },
        {
          label: "Share Feedback",
          click: () =>
            shell.openExternal("https://github.com/liteaiagent/liteai/issues"),
        },
        {
          label: "Report a Bug",
          click: () => shell.openExternal("https://github.com/liteaiagent/liteai/issues"),
        },
      ],
    },
  ]
