export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de LiteAI",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de LiteAI. ¿Quieres instalarla y reiniciar?",
