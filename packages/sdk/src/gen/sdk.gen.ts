...
export class Plan extends HeyApiClient {
    ...
    public resolve<ThrowOnError extends boolean = false>(parameters: {
        ...
        return (options?.client ?? this.client).post<ProjectSessionPlanResolveResponses, ProjectSessionPlanResolveErrors, ThrowOnError>({
...
export class Session extends HeyApiClient {
    ...
    public history<ThrowOnError extends boolean = false>(parameters: {
        ...
        const params = buildClientParams([parameters], [{ args: [{ in: 'path', key: 'projectID' }, { in: 'query', key: 'workspace' }] }]);
        return (options?.client ?? this.client).get<ProjectSessionHistoryResponses, ProjectSessionHistoryErrors, ThrowOnError>({
     ...
     */
    public setPermissionMode<ThrowOnError extends boolean = false>(parameters: {
        sessionID: string;
        projectID: string;
        workspace?: string;
        ...
        return (options?.client ?? this.client).post<ProjectSessionSetPermissionModeResponses, ProjectSessionSetPermissionModeErrors, ThrowOnError>({
     ...
     *
     * Resume a session paused in step mode, optionally injecting user guidance or disabling step mode.
     */
    public resume<ThrowOnError extends boolean = false>(parameters: {
        ...
        const params = buildClientParams([parameters], [{ args: [
                    ...
                    { in: 'body', key: 'disableStepMode' }
                ] }]);
        return (options?.client ?? this.client).post<ProjectSessionResumeResponses, ProjectSessionResumeErrors, ThrowOnError>({
    ...
    /**
     * Step back to a previous checkpoint
     *
     ...
     */
    public stepBack<ThrowOnError extends boolean = false>(parameters: {
        sessionID: string;
        projectID: string;
        workspace?: string;
        checkpointID?: string;
        ...
        return (options?.client ?? this.client).post<ProjectSessionStepBackResponses, ProjectSessionStepBackErrors, ThrowOnError>({
     ...
     */
    public forkAt<ThrowOnError extends boolean = false>(parameters: {
        sessionID: string;
        projectID: string;
        workspace?: string;
        checkpointID?: string;
        ...
        const params = buildClientParams([parameters], [{ args: [
                    ...
                    { in: 'body', key: 'agent' },
                    { in: 'body', key: 'guidance' },
                    { in: 'body', key: 'autoResume' }
                ] }]);
        return (options?.client ?? this.client).post<ProjectSessionForkAtResponses, ProjectSessionForkAtErrors, ThrowOnError>({
     ...
     *
     * Get all step-level checkpoints for a session, ordered by step. Messages are excluded.
     */
    public checkpoints<ThrowOnError extends boolean = false>(parameters: {
        sessionID: string;
        projectID: string;
        workspace?: string;
    }, options?: Options<never, ThrowOnError>) {
        ...
        return (options?.client ?? this.client).get<ProjectSessionCheckpointsResponses, ProjectSessionCheckpointsErrors, ThrowOnError>({
     ...
     *
     * Get full checkpoint data including messages for a specific checkpoint.
     */
    public checkpoint<ThrowOnError extends boolean = false>(parameters: {
        sessionID: string;
        checkpointID: string;
        projectID: string;
        workspace?: string;
        ...
        return (options?.client ?? this.client).get<ProjectSessionCheckpointResponses, ProjectSessionCheckpointErrors, ThrowOnError>({
...
export class Style extends HeyApiClient {
    /**
     * List output styles
     *
     * Get all available output styles from the project's .liteai/styles/ directory.
     */
    public list<ThrowOnError extends boolean = false>(parameters: {
        projectID: string;
        workspace?: string;
        ...
        const params = buildClientParams([parameters], [{ args: [{ in: 'path', key: 'projectID' }, { in: 'query', key: 'workspace' }] }]);
        return (options?.client ?? this.client).get<ProjectStyleListResponses, unknown, ThrowOnError>({
     ...
     *
     * Get the currently active output style, or null if none is configured.
     */
    public active<ThrowOnError extends boolean = false>(parameters: {
        projectID: string;
        workspace?: string;
    }, options?: Options<never, ThrowOnError>) {
        const params = buildClientParams([parameters], [{ args: [{ in: 'path', key: 'projectID' }, { in: 'query', key: 'workspace' }] }]);
        return (options?.client ?? this.client).get<ProjectStyleActiveResponses, unknown, ThrowOnError>({
...
export class Project extends HeyApiClient {
    ...
    get style(): Style {
        return this._style ??= new Style({ client: this.client });
    }
...
export class Feedback extends HeyApiClient {
     ...
     * Submit feedback
     *
     * Submit a feedback report with optional transcript and environment info.
     */
    public submit<ThrowOnError extends boolean = false>(parameters?: {
        timestamp?: number;
        description?: string;
        sessionID?: string;
        transcript?: Array<{
        ...
        const params = buildClientParams([parameters], [{ args: [
                    { in: 'body', key: 'timestamp' },
                    { in: 'body', key: 'description' },
                    { in: 'body', key: 'sessionID' },
                    { in: 'body', key: 'transcript' },
                    { in: 'body', key: 'environment' }
                ] }]);
        return (options?.client ?? this.client).post<GlobalFeedbackSubmitResponses, unknown, ThrowOnError>({
            url: '/feedback',
            ...options,
            ...params,
            headers: {
     ...
     */
    public rate<ThrowOnError extends boolean = false>(parameters?: {
        sessionID?: string;
        messageID?: string;
        rating?: 'good' | 'bad';
        timestamp?: number;
        ...
        return (options?.client ?? this.client).post<GlobalFeedbackRateResponses, unknown, ThrowOnError>({
            url: '/feedback/rate',
            ...options,
            ...params,
            headers: {
     ...
     *
     * Submit a session-level feedback survey response.
     */
    public survey<ThrowOnError extends boolean = false>(parameters?: {
        sessionID?: string;
        ...
        return (options?.client ?? this.client).post<GlobalFeedbackSurveyResponses, unknown, ThrowOnError>({
            url: '/feedback/survey',
            ...options,
            ...params,
            headers: {
