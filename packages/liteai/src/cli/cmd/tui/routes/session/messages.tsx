...
export function UserMessage(props: {
  ...
  const visible = createMemo(() => queued() || ctx.showTimestamps())
        ...
        >
          ...
          >
            ...
            <Show when={files().length}>
              <box flexDirection="row" paddingBottom={visible() ? 1 : 0} paddingTop={1} gap={1} flexWrap="wrap">
                <For each={files()}>
                  {(file) => {
                    const bg = createMemo(() => {
          ...
          return (
            <Show when={component()}>
              <Dynamic
                ...
                component={component()}
                // biome-ignore lint/suspicious/noExplicitAny: Dynamic component requires flexible part type across text/tool/reasoning views
                part={part as any}
