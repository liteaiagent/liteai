...
import { type AccessToken, Account, type AccountID, AccountRepoError, type OrgID, type RefreshToken } from "./schema"
...
export class AccountRepo extends ServiceMap.Service<AccountRepo, AccountRepo.Service>()("@liteai/AccountRepo") {
