...
This directory contains a clean, protocol-compliant implementation of the [Agent Client Protocol](https://agentclientprotocol.com/) for liteai.
...
- **`session.ts`** - Session state management
  ...
  - Maps ACP sessions to internal liteai sessions
...
- **Terminal Integration**: Full terminal support via liteai's bash tool
...
echo '{"jsonrpc":"2.0","id":1,"method":"initialize","params":{"protocolVersion":1}}' | liteai acp
```
...
ACP sessions map cleanly to liteai's internal session model:
