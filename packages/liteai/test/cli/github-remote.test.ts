...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/liteaiagent/liteai.git")).toEqual({
    owner: "liteaiagent",
    repo: "liteai",
  })
})
...
test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/liteaiagent/liteai")).toEqual({ owner: "liteaiagent", repo: "liteai" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:liteaiagent/liteai.git")).toEqual({ owner: "liteaiagent", repo: "liteai" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:liteaiagent/liteai")).toEqual({ owner: "liteaiagent", repo: "liteai" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/liteaiagent/liteai.git")).toEqual({
    owner: "liteaiagent",
    repo: "liteai",
  })
})
...
test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/liteaiagent/liteai")).toEqual({ owner: "liteaiagent", repo: "liteai" })
})
