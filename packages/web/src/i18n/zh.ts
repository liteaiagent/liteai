...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 LiteAI 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 LiteAI 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 LiteAI 中使用 {{provider}} 模型。",
  ...
  "error.page.report.prefix": "请将此错误报告给 LiteAI 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (liteai.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: LiteAI 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "LiteAI 提供免费模型，你可以立即开始使用。",
  ...
  "settings.general.row.language.description": "更改 LiteAI 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 LiteAI 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 LiteAI 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 LiteAI 的主题。",
