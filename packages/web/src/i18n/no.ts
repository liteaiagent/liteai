...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i LiteAI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i LiteAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i LiteAI.",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (liteai.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at LiteAI ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "LiteAI inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.general.row.appearance.description": "Tilpass hvordan LiteAI ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om LiteAI skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan LiteAI er tematisert.",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av LiteAI.",
