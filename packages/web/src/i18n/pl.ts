export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez LiteAI",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w LiteAI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w LiteAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w LiteAI.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w liteai.json",
  ...
  "dialog.server.description": "Przełącz serwer LiteAI, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja LiteAI ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu LiteAI",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (liteai.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, LiteAI does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "LiteAI zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla LiteAI",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd LiteAI na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy LiteAI ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw LiteAI.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania LiteAI",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji LiteAI.",
