export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in LiteAI.",
  ...
  "provider.connect.opencodeZen.freeHint": "Leave empty to connect with free models only",
  "provider.connect.apiKey.placeholder.optional": "API key (optional for free models)",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in LiteAI.",
  ...
  "error.chain.checkConfig": "Check your config (liteai.json) provider/model names",
  ...
  "settings.general.row.appearance.description": "Customise how LiteAI looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether LiteAI follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how LiteAI is themed.",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of LiteAI.",
  ...
  "settings.agents.loaded": "{{count}} agents available",
  "settings.agents.empty": "No agents available",
  "settings.agents.noWorkspace": "Agents are loaded per workspace. Open a workspace to view them.",
  "settings.agents.mode.subagent": "sub-agent",
  "settings.agents.mode.primary": "primary",
  "settings.agents.mode.all": "all",
  "settings.agents.tag.native": "built-in",
