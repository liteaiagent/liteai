...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "LiteAI 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 LiteAI 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 LiteAI 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 並輸入以下程式碼，以連線你的帳戶並在 LiteAI 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 liteai.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 LiteAI 伺服器。",
  ...
  "toast.update.description": "LiteAI 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 LiteAI 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (liteai.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: LiteAI 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "LiteAI 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 LiteAI 伺服器。",
  ...
  "settings.general.row.language.description": "變更 LiteAI 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 LiteAI 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 LiteAI 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 LiteAI 的主題。",
  ...
  "settings.updates.row.startup.description": "在 LiteAI 啟動時自動檢查更新",
