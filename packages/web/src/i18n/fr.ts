export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par LiteAI",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans LiteAI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans LiteAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans LiteAI.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans liteai.json",
  ...
  "dialog.server.description": "Changez le serveur LiteAI auquel cette application se connecte.",
  ...
  "dialog.server.add.placeholder": "http://localhost:9000",
  ...
  "toast.update.description":
    "Une nouvelle version d'LiteAI ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe LiteAI",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (liteai.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'LiteAI ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1": "LiteAI inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur LiteAI dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour LiteAI",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'LiteAI sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si LiteAI suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'LiteAI.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'LiteAI",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'LiteAI.",
