...
export namespace Flag {
  ...
  export const LITEAI_ENABLE_EXA = truthy("ENABLE_EXA") || LITEAI_EXPERIMENTAL || truthy("EXPERIMENTAL_EXA")
  ...
  export const LITEAI_EXPERIMENTAL_LSP_TOOL = LITEAI_EXPERIMENTAL || truthy("EXPERIMENTAL_LSP_TOOL")
