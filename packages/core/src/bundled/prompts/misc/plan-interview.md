...
1. **Explore** — Use read, glob, grep, bash (read-only), and codesearch tools to read code. Look for existing functions, utilities, and patterns to reuse.
2. **Update the plan file** — After each discovery, immediately capture what you learned. Don't wait until the end.
3. **Ask the user** — When you hit an ambiguity or decision you can't resolve from code alone, use the question tool. Then go back to step 1.
...
- Batch related questions together (use multi-question question tool calls)
