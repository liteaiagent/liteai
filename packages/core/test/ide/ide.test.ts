...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders LITEAI_CALLER", () => {
    process.env.LITEAI_CALLER = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode LITEAI_CALLER", () => {
    process.env.LITEAI_CALLER = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown LITEAI_CALLER", () => {
    process.env.LITEAI_CALLER = "unknown"
