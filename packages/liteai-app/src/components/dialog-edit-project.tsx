      ...
      <form onSubmit={handleSubmit} class="flex flex-col gap-6 p-6 pt-0">
        <div class="flex flex-col gap-4">
          ...
          <div class="flex flex-col gap-2">
            <label for="icon-upload" class="text-12-medium text-text-weak">
            ...
            <div class="flex gap-3 items-start">
              ...
              >
                <button
                  type="button"
                  class="relative size-16 block p-0 rounded-md transition-colors cursor-pointer text-left"
                  classList={{
          ...
          <Show when={!store.iconUrl}>
            <div class="flex flex-col gap-2">
              <span class="text-12-medium text-text-weak">{language.t("dialog.project.edit.color")}</span>
