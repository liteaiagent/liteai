...
beforeAll(async () => {
  ...
  mock.module("@liteai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@liteai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@liteai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@liteai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
