...
export function DialogReleaseNotes(props: { highlights: Highlight[] }) {
  ...
  return (
    ...
    >
      {/* biome-ignore lint/a11y/noStaticElementInteractions: catching global keys */}
      <div role="presentation" class="flex flex-1 min-w-0 min-h-0" autofocus onKeyDown={handleKeyDown}>
