...
export function DialogCustomProvider(props: Props) {
  ...
  const validate = () => {
    ...
    batch(() => {
      ...
      output.headers.forEach((err, index) => {
        setForm("headers", index, "err", err)
      })
    })
      ...
      <div class="flex flex-col gap-6 px-2.5 pb-3 overflow-y-auto max-h-[60vh]">
        ...
        <form onSubmit={save} class="px-2.5 pb-6 flex flex-col gap-6">
          <p class="text-14-regular text-text-base">
            ...
            <Link href="https://liteai.com/docs/providers/#custom-provider" tabIndex={-1}>
          ...
          <div class="flex flex-col gap-3">
            <div class="text-12-medium text-text-weak">{language.t("provider.custom.models.label")}</div>
          ...
          <div class="flex flex-col gap-3">
            <div class="text-12-medium text-text-weak">{language.t("provider.custom.headers.label")}</div>
