...
import type { ListRef } from "@liteai/ui/list"
...
function cleanInput(value: string) {
  ...
  // biome-ignore lint/suspicious/noControlCharactersInRegex: Explicitly stripping control characters
        ...
        search={{
          ...
          action: (
            <IconButton
              ...
              variant="ghost"
              onClick={native}
              aria-label={language.t("dialog.directory.browse")}
