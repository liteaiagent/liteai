export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u LiteAI-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u LiteAI-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u LiteAI-u.",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (liteai.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: LiteAI još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "LiteAI uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako LiteAI izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li LiteAI prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu LiteAI-a.",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju LiteAI-a.",
