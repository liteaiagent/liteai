export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en LiteAI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en LiteAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en LiteAI.",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (liteai.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, LiteAI no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "LiteAI incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve LiteAI en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si LiteAI sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de LiteAI.",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de LiteAI.",
