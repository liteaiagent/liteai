...
const STORAGE_KEYS = {
	THEME_ID: "liteai-theme-id",
	COLOR_SCHEME: "liteai-color-scheme",
	THEME_CSS_LIGHT: "liteai-theme-css-light",
	THEME_CSS_DARK: "liteai-theme-css-dark",
} as const;
	...
	init: (props: {
		...
		window.addEventListener("storage", (e) => {
			...
			if (e.key === STORAGE_KEYS.COLOR_SCHEME && e.newValue) {
				...
				setStore(
					"mode",
					e.newValue === "system" ? getSystemMode() : (e.newValue as any),
				);
			}
		});
