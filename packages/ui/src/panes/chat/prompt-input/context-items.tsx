...
import { getDirectory, getFilename, getFilenameTruncated } from "@liteai/util/path"
import { type Component, For, Show } from "solid-js"
import type { ContextItem } from "../../shared/prompt"
          ...
          {(item) => {
            ...
            return (
              <Tooltip
                ...
                openDelay={2000}
              >
                {/* biome-ignore lint/a11y/useKeyWithClickEvents: nested buttons */}
                {/* biome-ignore lint/a11y/noStaticElementInteractions: nested buttons */}
                <div
                  classList={{
