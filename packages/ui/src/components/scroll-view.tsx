import { type ComponentProps, mergeProps, onCleanup, onMount, Show, splitProps } from "solid-js"
import { createStore } from "solid-js/store"
import { useI18n } from "../context/i18n"

export interface ScrollViewProps extends ComponentProps<"div"> {
  viewportRef?: (el: HTMLElement) => void
  ...
  return (
    ...
    >
      ...
      <section
        ...
        onScroll={(e) => {
          updateThumb()
          if (typeof events.onScroll === "function") events.onScroll(e as never)
        }}
        onWheel={events.onWheel as never}
        onTouchStart={events.onTouchStart as never}
        onTouchMove={events.onTouchMove as never}
        onTouchEnd={events.onTouchEnd as never}
        onTouchCancel={events.onTouchCancel as never}
        onPointerDown={events.onPointerDown as never}
        onClick={events.onClick as never}
        aria-label={i18n.t("ui.scrollView.ariaLabel")}
        onKeyDown={(e) => {
          onKeyDown(e)
          if (typeof events.onKeyDown === "function") events.onKeyDown(e as never)
        }}
      >
        {local.children}
      </section>
