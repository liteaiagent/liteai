				...
				<Card variant="error" class="error-card">
					<div class="flex items-start gap-2">
						...
						<div class="min-w-0">
							...
							<Show when={info()}>
								{(line) => (
									<div data-slot="session-turn-retry-info">{line()}</div>
								)}
							</Show>
						</div>
					</div>
