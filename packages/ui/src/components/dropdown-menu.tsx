...
export interface DropdownMenuTriggerProps
	extends ComponentProps<typeof Kobalte.Trigger> {}
export interface DropdownMenuIconProps
	extends ComponentProps<typeof Kobalte.Icon> {}
export interface DropdownMenuPortalProps
	extends ComponentProps<typeof Kobalte.Portal> {}
export interface DropdownMenuContentProps
	extends ComponentProps<typeof Kobalte.Content> {}
export interface DropdownMenuArrowProps
	extends ComponentProps<typeof Kobalte.Arrow> {}
export interface DropdownMenuSeparatorProps
	extends ComponentProps<typeof Kobalte.Separator> {}
export interface DropdownMenuGroupProps
	extends ComponentProps<typeof Kobalte.Group> {}
export interface DropdownMenuGroupLabelProps
	extends ComponentProps<typeof Kobalte.GroupLabel> {}
export interface DropdownMenuItemProps
	extends ComponentProps<typeof Kobalte.Item> {}
export interface DropdownMenuItemLabelProps
	extends ComponentProps<typeof Kobalte.ItemLabel> {}
...
export interface DropdownMenuRadioGroupProps
	extends ComponentProps<typeof Kobalte.RadioGroup> {}
export interface DropdownMenuRadioItemProps
	extends ComponentProps<typeof Kobalte.RadioItem> {}
export interface DropdownMenuCheckboxItemProps
	extends ComponentProps<typeof Kobalte.CheckboxItem> {}
export interface DropdownMenuSubProps
	extends ComponentProps<typeof Kobalte.Sub> {}
export interface DropdownMenuSubTriggerProps
	extends ComponentProps<typeof Kobalte.SubTrigger> {}
export interface DropdownMenuSubContentProps
	extends ComponentProps<typeof Kobalte.SubContent> {}
...
function DropdownMenuGroupLabel(
	props: ParentProps<DropdownMenuGroupLabelProps>,
) {
	const [local, rest] = splitProps(props, ["class", "classList", "children"]);
	return (
		<Kobalte.GroupLabel
...
function DropdownMenuItemDescription(
	props: ParentProps<DropdownMenuItemDescriptionProps>,
) {
	const [local, rest] = splitProps(props, ["class", "classList", "children"]);
	return (
...
function DropdownMenuRadioGroup(
	props: ParentProps<DropdownMenuRadioGroupProps>,
) {
	const [local, rest] = splitProps(props, ["class", "classList", "children"]);
	return (
		<Kobalte.RadioGroup
...
function DropdownMenuCheckboxItem(
	props: ParentProps<DropdownMenuCheckboxItemProps>,
) {
	const [local, rest] = splitProps(props, ["class", "classList", "children"]);
	return (
...
function DropdownMenuSubTrigger(
	props: ParentProps<DropdownMenuSubTriggerProps>,
) {
	const [local, rest] = splitProps(props, ["class", "classList", "children"]);
	return (
		<Kobalte.SubTrigger
...
function DropdownMenuSubContent(
	props: ParentProps<DropdownMenuSubContentProps>,
) {
	const [local, rest] = splitProps(props, ["class", "classList", "children"]);
	return (
		<Kobalte.SubContent
