		...
		<span ref={ref} data-component="shell-submessage">
			...
			>
				<span data-slot="basic-tool-tool-subtitle">
					<span data-slot="shell-submessage-value">
						{props.text || "\u00A0"}
					</span>
				</span>
			</span>
		...
		return (
			...
			>
				...
				<div style={{ display: "flex", gap: "8px", "flex-wrap": "wrap" }}>
					<button type="button" onClick={replay} style={btn()}>
						Replay entry
					</button>
					<button
						type="button"
						onClick={() => setState("show", (value) => !value)}
						style={btn(show())}
					>
						{show() ? "Hide subtitle" : "Show subtitle"}
					</button>
					<button type="button" onClick={toggleAuto} style={btn(auto())}>
				...
				>
					...
					>
						...
						<input
							...
							onInput={(e) =>
								setState("visualDuration", Number(e.currentTarget.value))
							}
						/>
