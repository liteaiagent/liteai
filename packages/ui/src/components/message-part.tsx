...
PART_MAPPING["reasoning"] = function ReasoningPartDisplay(props) {
  ...
  const elapsedLabel = () => {
    ...
    if (s >= 60) return i18n.t("ui.message.duration.minutesSeconds", { minutes: Math.floor(s / 60), seconds: s % 60 })
  ...
  const label = () => {
    ...
    if (s >= 60) return i18n.t("ui.reasoning.thoughtFor", { duration: i18n.t("ui.message.duration.minutesSeconds", { minutes: Math.floor(s / 60), seconds: s % 60 }) })
    return i18n.t("ui.reasoning.thoughtFor", { duration: i18n.t("ui.message.duration.seconds", { count: s }) })
  }
        ...
        trigger={
          <div data-slot="basic-tool-tool-info-structured">
            <div data-slot="basic-tool-tool-info-main">
              ...
              <Show when={query()}>
                <span data-slot="basic-tool-tool-subtitle" class="exa-tool-query">
                  {query()}
                </span>
              </Show>
            </div>
      ...
      <BasicTool
        ...
        trigger={
          <div data-slot="basic-tool-tool-info-structured">
            <div data-slot="basic-tool-tool-info-main">
              <span data-slot="basic-tool-tool-title">
                <TextShimmer text={i18n.t("ui.tool.codesearch")} active={pending()} />
              </span>
              <Show when={query()}>
                <span data-slot="basic-tool-tool-subtitle" class="exa-tool-query">
                  {query()}
