      ...
      >
        ...
        <div style={{ display: "grid", gap: "12px" }}>
          <div style={{ display: "flex", gap: "8px", "flex-wrap": "wrap" }}>
            <button type="button" onClick={toggleCycling} style={btn(cycling())}>
            ...
            <button type="button" onClick={() => setState("active", (value) => !value)} style={smallBtn(active())}>
              {active() ? "Shimmer: on" : "Shimmer: off"}
            </button>
            <button type="button" onClick={() => setState("debug", (value) => !value)} style={smallBtn(debug())}>
              {debug() ? "Debug mask: on" : "Debug mask"}
            </button>
            <button type="button" onClick={() => setState("odoBlur", (value) => !value)} style={smallBtn(odoBlur())}>
