...
export const Playground = {
	render: () => {
		...
		const prev = () =>
			setState("index", (value) => (value - 1 + TEXTS.length) % TEXTS.length);
		...
		return (
			...
			>
				...
				<div style={{ display: "flex", gap: "8px", "flex-wrap": "wrap" }}>
					<button type="button" onClick={prev} style={btn()}>
						Prev
					</button>
					<button type="button" onClick={next} style={btn()}>
						Next
					</button>
					<button type="button" onClick={toggleCycle} style={btn(cycling())}>
						{cycling() ? "Stop cycle" : "Auto cycle"}
					</button>
					<button
						type="button"
						onClick={() => setState("growOnly", (value) => !value)}
						style={btn(growOnly())}
					>
				...
				<div style={{ display: "grid", gap: "8px", "max-width": "480px" }}>
					...
					>
						...
						<input
							...
							value={hybridEdge()}
							onInput={(e) =>
								setState("hybridEdge", e.currentTarget.valueAsNumber)
							}
							style={{ flex: 1 }}
						/>
						<span
					...
					>
						...
						<input
							...
							value={hybridTravel()}
							onInput={(e) =>
								setState("hybridTravel", e.currentTarget.valueAsNumber)
							}
							style={{ flex: 1 }}
						/>
						<span
					...
					>
						...
						<input
							...
							value={duration()}
							onInput={(e) =>
								setState("duration", e.currentTarget.valueAsNumber)
							}
							style={{ flex: 1 }}
						/>
						<span
					...
					>
						...
						<input
							...
							value={bounceSoft()}
							onInput={(e) =>
								setState("bounceSoft", e.currentTarget.valueAsNumber)
							}
							style={{ flex: 1 }}
						/>
						<span
					...
					>
						...
						<input
							...
							value={revealTravel()}
							onInput={(e) =>
								setState("revealTravel", e.currentTarget.valueAsNumber)
							}
							style={{ flex: 1 }}
						/>
						<span
