...
export const Playground = {
	render: () => {
		...
		const collapsed = () =>
			!!composerRef?.querySelector(
				'[data-action="session-todo-toggle-button"][data-collapsed="true"]',
			);

		const setCollapsed = (value: boolean) => {
			const button = composerRef?.querySelector(
		...
		return (
			<div data-component="todo-stage">
							...
							<div data-component="todo-session-panel">
								...
								<div ref={composerRef}>
									<SessionComposerRegion
										...
										subtitleTravel={
											subtitleAuto() ? undefined : subtitleTravel()
										}
				...
				<div style={{ display: "flex", gap: "8px", "flex-wrap": "wrap" }}>
					<button type="button" onClick={toggleDock} style={btn(dockOpen())}>
						{dockOpen() ? "Animate close" : "Animate open"}
					</button>
					<button
						type="button"
						onClick={toggleDrawer}
						style={btn(dockOpen() && collapsed())}
					>
						{dockOpen() && collapsed()
							? "Expand todo dock"
							: "Collapse todo dock"}
					</button>
					<button type="button" onClick={cycle} style={btn(step() > 0)}>
						Cycle progress ({step()}/3 done)
					</button>
					{[0, 1, 2, 3].map((value) => (
						<button
							type="button"
							onClick={() => setCfg("step", value)}
							style={btn(step() === value)}
						>
							{value} done
						</button>
					))}
				...
				<div style={{ display: "grid", gap: "10px", "max-width": "560px" }}>
					...
					>
						...
						<input
							...
							onInput={(event) =>
								setCfg("dockOpenDuration", event.currentTarget.valueAsNumber)
							}
							style={{ flex: 1 }}
						/>
						<span
					...
					>
						...
						<input
							...
							onInput={(event) =>
								setCfg("dockOpenBounce", event.currentTarget.valueAsNumber)
							}
							style={{ flex: 1 }}
						/>
						<span
					...
					>
						...
						<input
							...
							onInput={(event) =>
								setCfg("dockCloseDuration", event.currentTarget.valueAsNumber)
							}
							style={{ flex: 1 }}
						/>
						<span
					...
					>
						...
						<input
							...
							onInput={(event) =>
								setCfg("dockCloseBounce", event.currentTarget.valueAsNumber)
							}
							style={{ flex: 1 }}
						/>
						<span
					...
					>
						...
						<input
							...
							onInput={(event) =>
								setCfg("drawerExpandBounce", event.currentTarget.valueAsNumber)
							}
							style={{ flex: 1 }}
						/>
						<span
					...
					>
						...
						<input
							...
							onInput={(event) =>
								setCfg("subtitleDuration", event.currentTarget.valueAsNumber)
							}
							style={{ flex: 1 }}
						/>
						<span
					...
					>
						...
						<input
							...
							onInput={(event) =>
								setCfg("subtitleAuto", event.currentTarget.checked)
							}
						/>
						<span
							style={{
					...
					>
						...
						<input
							...
							onInput={(event) =>
								setCfg("subtitleTravel", event.currentTarget.valueAsNumber)
							}
							style={{ flex: 1 }}
						/>
						<span
					...
					>
						...
						<input
							...
							value={subtitleEdge()}
							onInput={(event) =>
								setCfg("subtitleEdge", event.currentTarget.valueAsNumber)
							}
							style={{ flex: 1 }}
						/>
						<span
					...
					>
						...
						<input
							...
							value={countDuration()}
							onInput={(event) =>
								setCfg("countDuration", event.currentTarget.valueAsNumber)
							}
							style={{ flex: 1 }}
						/>
						<span
					...
					>
						...
						<input
							...
							value={countMask()}
							onInput={(event) =>
								setCfg("countMask", event.currentTarget.valueAsNumber)
							}
							style={{ flex: 1 }}
						/>
						<span
					...
					>
						...
						<input
							...
							onInput={(event) =>
								setCfg("countMaskHeight", event.currentTarget.valueAsNumber)
							}
							style={{ flex: 1 }}
						/>
						<span
					...
					>
						...
						<input
							...
							onInput={(event) =>
								setCfg("countWidthDuration", event.currentTarget.valueAsNumber)
							}
							style={{ flex: 1 }}
						/>
						<span
