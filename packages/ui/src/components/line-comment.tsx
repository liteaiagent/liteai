		...
		>
				...
				fallback={
					<>
						<button
							...
							on:click={props.onClick as unknown as (e: Event) => void}
							on:mouseenter={
								props.onMouseEnter as unknown as (e: Event) => void
							}
						>
							<Show
								when={props.inline}
								fallback={
									<Icon
										name={icon() === "plus" ? "plus-small" : "comment"}
										size="small"
									/>
								}
							>
						...
						<Show when={props.open}>
							<div
								...
								on:mousedown={(e) => e.stopPropagation()}
								on:focusout={
									props.onPopoverFocusOut as unknown as (e: Event) => void
								}
							>
								{props.children}
							</div>
			...
			>
				<div
					...
					on:mousedown={(e) => e.stopPropagation()}
					on:click={props.onClick as unknown as (e: Event) => void}
					on:mouseenter={props.onMouseEnter as unknown as (e: Event) => void}
					on:focusout={props.onPopoverFocusOut as unknown as (e: Event) => void}
				>
					{props.children}
				</div>
			</Show>
						...
						fallback={
							<>
								<button
									...
									data-variant="ghost"
									on:click={split.onCancel as unknown as (e: Event) => void}
								>
								...
								<button
									...
									on:click={submit as unknown as (e: Event) => void}
								>
