...
export interface ToastRegionProps
	extends ComponentProps<typeof Kobalte.Region> {}
...
function ToastDescription(
	props: ToastDescriptionProps & ComponentProps<"div">,
) {
...
function ToastCloseButton(
	props: ToastCloseButtonProps & ComponentProps<"button">,
) {
	const i18n = useI18n();
	return (
		<Kobalte.CloseButton
...
function ToastProgressTrack(
	props: ComponentProps<typeof Kobalte.ProgressTrack>,
) {
...
export function showToast(options: ToastOptions | string) {
	...
	return toaster.show((props) => (
		...
		>
			<Show when={opts.icon}>
				<Toast.Icon name={opts.icon as IconProps["name"]} />
			</Show>
			<Toast.Content>
		...
		>
			<Toast.Content>
				<Toast.Description>
					...
					{props.state === "fulfilled" && options.success?.(props.data as T)}
