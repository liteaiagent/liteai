  ...
  return (
    <div data-component="session-review" class={props.class} classList={props.classList}>
      ...
      <ScrollView
        ...
        onScroll={props.onScroll as JSX.EventHandlerUnion<HTMLDivElement, Event>}
        classList={{
              ...
              <Accordion multiple value={open()} onChange={handleChange}>
                <For each={files()}>
                  {(file) => {
                    ...
                    const item = createMemo(() => diffs().get(file) as ReviewDiff)
                    ...
                    const commentsUi = createLineCommentController<SessionReviewComment>({
                      ...
                      renderCommentActions: props.lineCommentActions
                        ? (_comment, controls) => (
                            <ReviewCommentMenu
                              labels={props.lineCommentActions as SessionReviewCommentActions}
