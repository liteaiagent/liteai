...
import type { AssistantMessage, FileDiff, Message as MessageType, Part as PartType } from "@liteai-ai/sdk/client"
          ...
          <Show when={message()}>
            ...
            >
              <div data-slot="session-turn-message-content" aria-live="off">
                <Message message={message() as MessageType} parts={parts()} actions={props.actions} />
              </div>
              <Show when={divider()}>
