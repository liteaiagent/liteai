...
describe("Keybind.format", () => {
  ...
  test("should convert shift modifier to string", () => {
    ...
    expect(Keybind.format(info)).toBe("shift+return")
  })
  ...
  test("should convert special key to string", () => {
    ...
    expect(Keybind.format(info)).toBe("pgup")
  })
  ...
  test("should convert super modifier to string", () => {
    ...
    expect(Keybind.format(info)).toBe("super+z")
  })
  ...
  test("should convert super+shift modifier to string", () => {
    ...
    expect(Keybind.format(info)).toBe("super+shift+z")
  })
  ...
  test("should handle super with ctrl modifier", () => {
    ...
    expect(Keybind.format(info)).toBe("ctrl+super+a")
  })
  ...
  test("should handle super with all modifiers", () => {
    ...
    expect(Keybind.format(info)).toBe("ctrl+alt+super+shift+x")
  })
