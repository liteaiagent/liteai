...
- [x] T035 *(N/A)* [FR-013] `run_command` read-only whitelist for "plan" mode — not applicable: `plan_enter` blocks the root agent (cannot invoke tools), plan subagent runs with default permissions (full bash access).
