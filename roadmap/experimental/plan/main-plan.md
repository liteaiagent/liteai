...
>
> **Reference:** liteai_cli_mvp's `BashTool.tsx` (1144 lines) implements a full command lifecycle with background tasks, progress generators, auto-backgrounding, output persistence, and semantic exit code interpretation.
>
